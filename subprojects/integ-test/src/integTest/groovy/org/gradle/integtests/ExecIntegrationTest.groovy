...
class ExecIntegrationTest extends AbstractIntegrationSpec {
    ...
    def 'can execute java with #task'() {
        ...
        buildFile << """
            ...
            javaexecInjectedTaskAction.execClasspath.from(sourceSets['main'].output.classesDirs)
        """.stripIndent()
    ...
    def 'can execute commands with #task'() {
        ...
        buildFile << """
            ...
            execInjectedTaskAction.execClasspath.from(sourceSets['main'].runtimeClasspath)
        """.stripIndent()
